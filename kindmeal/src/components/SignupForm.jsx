import { Box,Flex,Text,FormControl,FormLabel,Input,Select,Radio, RadioGroup, Stack,  Image,   UnorderedList,ListItem  } from "@chakra-ui/react";
            ...
            <FormControl w='80%' >
                        ...
                        <Select placeholder='India' borderColor='gray.500' >
                                {
                                    country_list.map((country , i)=>(
                                        <option  value={`option${i+1}`} > {country} </option>
                                    ))
                                }
                ...
                <Flex  mt='5'  >
                    ...
                    <Box w='30%'>
                        <RadioGroup  >
                            <Stack direction='row'>
                                <Radio borderColor='gray.500'   value='1'>Male</Radio>
                                <Radio  borderColor='gray.500'  value='2'>Female</Radio>
                            </Stack>
                        </RadioGroup>
                    </Box>
                </Flex>
                <Input textAling='left' type='submit' h='60px' w='30%' pl='6' pr='6' m='5' bg='red.500' color='#fff' fontWeight='600' fontSize='1.5vw' value='Join Now'  />
            </FormControl>
